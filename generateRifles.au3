...
InsertScope("Nightforce ATACR F1", "hlc_optic_ATACR", 4.2098)

;displayname, classname, barrellength, barreltwist, railHeightAboveBore
...
InsertRifle("G29", "BWA3_G29", 690, 254, 3.8)
AddMagazineWellToRifle("BWA3_G29", "BWA3_G29")


InsertRifle("G28 E2 Standard", "BWA3_G28", 421, 304.8, 3.6)
AddMagazineWellToRifle("BWA3_G28", "BWA3_G28")
...
Local $barrelLengths[3] = [508.0, 660.4, 711.2]
Local $muzzleVelocities[3] = [880, 915, 925]
Local $muzzleVelocityShifts[11] = [-26.55,-25.47,-22.85,-20.12,-16.98,-12.8,-7.64,-1.53,5.96,15.17,26.19]
;Display, class, caliber, dragModel, BC, mass, length
InsertAmmoTypeSeperate("G29 8.6x70mm (BWA3)", "BWA3_B_86x70_Ball", 8.585, 7, 0.322, 16.2, 39.573, $barrelLengths, $muzzleVelocities, $muzzleVelocityShifts)
AddAmmoToMagazineWell("BWA3_G29", "BWA3_B_86x70_Ball")
...
Local $muzzleVelocityShifts[11] = [-26.55,-25.47,-22.85,-20.12,-16.98,-12.8,-7.64,-1.53,5.96,15.17,26.19]
;Display, class, caliber, dragModel, BC, mass, length
InsertAmmoTypeSeperate("G28 7.62x51 (norm and tracer) (BWA3)", "BWA3_B_762x51_Ball", 7.823, 7, 0.2, 9.4608, 28.956, $barrelLengths, $muzzleVelocities, $muzzleVelocityShifts)
AddAmmoToMagazineWell("BWA3_G28", "BWA3_B_762x51_Ball")

;Yes they are the same
InsertAmmoTypeSeperate("G28 7.62x51 Tracer IR-DIM (BWA3)", "BWA3_B_762x51_Ball_Tracer_Dim", 7.823, 7, 0.2, 9.4608, 28.956, $barrelLengths, $muzzleVelocities, $muzzleVelocityShifts)
AddAmmoToMagazineWell("BWA3_G28", "BWA3_B_762x51_Ball_Tracer_Dim")

Local $barrelLengths[3] = [330.2,406.4,508]
Local $muzzleVelocities[3] = [875,910,930]
Local $muzzleVelocityShifts[11] = [-26.55,-25.47,-22.85,-20.12,-16.98,-12.8,-7.64,-1.53,5.96,15.17,26.19]
;Display, class, caliber, dragModel, BC, mass, length
InsertAmmoTypeSeperate("G28 7.62x51 AP (BWA3)", "BWA3_B_762x51_Ball_AP", 7.823, 1, 0.359, 8.22946, 31.496, $barrelLengths, $muzzleVelocities, $muzzleVelocityShifts)
AddAmmoToMagazineWell("BWA3_G28", "BWA3_B_762x51_Ball_AP")

Local $barrelLengths[4] = [406.4,508,609.6,660.4]
Local $muzzleVelocities[4] = [750,780,790,794]
Local $muzzleVelocityShifts[11] = [-26.55,-25.47,-22.85,-20.12,-16.98,-12.8,-7.64,-1.53,5.96,15.17,26.19]
;Display, class, caliber, dragModel, BC, mass, length
InsertAmmoTypeSeperate("G28 7.62x51 LR (BWA3)", "BWA3_B_762x51_Ball_LR", 7.823, 7, 0.243, 11.34, 31.496, $barrelLengths, $muzzleVelocities, $muzzleVelocityShifts)
AddAmmoToMagazineWell("BWA3_G28", "BWA3_B_762x51_Ball_LR")
...
Local $muzzleVelocityShifts[11] = [-2.655,-2.547,-2.285,-2.012,-1.698,-1.28,-0.764,-0.153,0.596,1.517,2.619]
;Display, class, caliber, dragModel, BC, mass, length
InsertAmmoTypeSeperate("G28 7.62x51 SD (BWA3)", "BWA3_B_762x51_Ball_SD", 7.823, 7, 0.235, 12.96, 34.036, $barrelLengths, $muzzleVelocities, $muzzleVelocityShifts)
AddAmmoToMagazineWell("BWA3_G28", "BWA3_B_762x51_Ball_SD")
